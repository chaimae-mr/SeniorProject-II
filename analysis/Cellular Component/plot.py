...
def calculate(i,j,heatmap_colors,heatmap_size):
    file = ['number_links_5_C.csv','number_links_6_C.csv','number_links_7_C.csv','number_links_8_C.csv','number_links_9_C.csv','number_links_10_C.csv']
