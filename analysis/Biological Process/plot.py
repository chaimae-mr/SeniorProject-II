...
def calculate(i,j,heatmap_colors,heatmap_size):
    file = ['number_links_5_P.csv','number_links_6_P.csv','number_links_7_P.csv','number_links_8_P.csv','number_links_9_P.csv','number_links_10_P.csv']
